/**
 * Iconos de marca (GitHub, LinkedIn). lucide-react dejó de incluirlos, así
 * que van como SVG inline con la misma API mínima (`size`, `className`).
 * Paths: simple-icons (viewBox 24, fill currentColor).
 */
